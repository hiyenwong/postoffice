package io.hiyenwong.postoffice.postoffice.wecom.domain;
...
public class WeComDomain {
    ...
    public static class TextBuilder {
        ...
        public io.hiyenwong.postoffice.wecom.domain.WeComDomain build() {
            return new io.hiyenwong.postoffice.wecom.domain.WeComDomain(new TextType(content, mentionedList, mentionedMobileList));
        }

        public io.hiyenwong.postoffice.wecom.domain.WeComDomain build(String robotKey) {
            return new io.hiyenwong.postoffice.wecom.domain.WeComDomain(new TextType(content, mentionedList, mentionedMobileList), robotKey);
        }
    }
    ...
    public static class MarkdownBuilder {
        ...
        public io.hiyenwong.postoffice.wecom.domain.WeComDomain build() {
            return new io.hiyenwong.postoffice.wecom.domain.WeComDomain(new MarkdownType(content));
        }

        public io.hiyenwong.postoffice.wecom.domain.WeComDomain build(String robotKey) {
            return new io.hiyenwong.postoffice.wecom.domain.WeComDomain(new MarkdownType(content), robotKey);
        }
    ...
    public static class ImageBuilder {
        ...
        public io.hiyenwong.postoffice.wecom.domain.WeComDomain build() {
            return new io.hiyenwong.postoffice.wecom.domain.WeComDomain(new ImageType(base64, md5));
        }

        public io.hiyenwong.postoffice.wecom.domain.WeComDomain build(String robotKey) {
            return new io.hiyenwong.postoffice.wecom.domain.WeComDomain(new ImageType(base64, md5), robotKey);
        }
    }
    ...
    public static class NewsBuilder {
        ...
        public io.hiyenwong.postoffice.wecom.domain.WeComDomain build() {
            return new io.hiyenwong.postoffice.wecom.domain.WeComDomain(new NewsType(articles));
        }

        public io.hiyenwong.postoffice.wecom.domain.WeComDomain build(String robotKey) {
            return new io.hiyenwong.postoffice.wecom.domain.WeComDomain(new NewsType(articles), robotKey);
        }
    }
    //endregion
}
